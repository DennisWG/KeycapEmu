@echo off
flatmessage_compiler -e "hpp" -t "E:\Programmieren\C++\Keycap\KeycapEmu\templates\hpp.template" -o "E:\Programmieren\C++\Keycap\KeycapEmu\build\x64-Debug\src" -i "E:\Programmieren\C++\Keycap\KeycapEmu\src\shared\network\network_constants.msg" -i "E:\Programmieren\C++\Keycap\KeycapEmu\src\logonserver\protocol\logon.msg"

flatmessage_compiler -e "hpp" -t "E:\Programmieren\C++\Keycap\KeycapEmu\templates\hpp.template" -o "E:\Programmieren\C++\Keycap\KeycapEmu\build\x64-Debug\src" -i "E:\Programmieren\C++\Keycap\KeycapEmu\src\realmserver\protocol\authentication.msg" -i "E:\Programmieren\C++\Keycap\KeycapEmu\src\shared\network\server.msg" -i "E:\Programmieren\C++\Keycap\KeycapEmu\src\shared\network\client.msg"
flatmessage_compiler -e "hpp" -t "E:\Programmieren\C++\Keycap\KeycapEmu\templates\hpp.template" -o "E:\Programmieren\C++\Keycap\KeycapEmu\build\x64-Debug\src" -i "E:\Programmieren\C++\Keycap\KeycapEmu\src\realmserver\protocol\character_select.msg" -i "E:\Programmieren\C++\Keycap\KeycapEmu\src\shared\network\server.msg" -i "E:\Programmieren\C++\Keycap\KeycapEmu\src\shared\network\client.msg"
flatmessage_compiler -e "hpp" -t "E:\Programmieren\C++\Keycap\KeycapEmu\templates\hpp.template" -o "E:\Programmieren\C++\Keycap\KeycapEmu\build\x64-Debug\src" -i "E:\Programmieren\C++\Keycap\KeycapEmu\src\realmserver\protocol\realm_protocol.msg" -i "E:\Programmieren\C++\Keycap\KeycapEmu\src\shared\network\server.msg" -i "E:\Programmieren\C++\Keycap\KeycapEmu\src\shared\network\client.msg"
